...
RSpec.describe Grimoire::SessionLogger do
  ...
  def new_logger(port: 8300)
    described_class.new(dir: @tmp_dir, port: port, clock: clock)
  end

  it 'creates a raw and parsed log file named with the port and a timestamp' do
    new_logger
